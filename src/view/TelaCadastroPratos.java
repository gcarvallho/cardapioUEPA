...
public class TelaCadastroPratos extends javax.swing.JFrame {

    public TelaCadastroPratos() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaCadastroPratos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaCadastroPratos().setVisible(true);
            }
        });
    }
